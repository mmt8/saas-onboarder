        ...
        <div className="max-w-4xl mx-auto px-6 pt-32 pb-40">
            ...
            <div className="prose prose-slate max-w-none space-y-8 text-foreground/80">
                <section>
                    ...
                    <p>
                        These General Terms and Conditions (GTC) apply to all contracts regarding the use of the Guidemark software between Guidemark and its customers.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Guidemark provides a SaaS solution for the creation of interactive product tours. The exact scope of services is based on the respective product description on the website.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        The use of Guidemark requires registration. By completing the registration, the customer makes an offer to conclude a usage contract. Guidemark accepts this offer by activating the account.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        Guidemark is liable without limitation for intent and gross negligence. In the case of slight negligence, Guidemark is only liable for the breach of an essential contractual obligation.
                    </p>
                </section>
