        ...
        <div className="min-h-[calc(100vh-80px)] flex items-center justify-center p-6 bg-secondary/20">
            <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-primary/5 border border-border/50 p-8 md:p-12">
                <div className="text-center mb-10">
                    ...
                    <p className="text-muted-foreground">Create your account to start building.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <label className="text-sm font-bold text-muted-foreground uppercase tracking-wider ml-1">Confirm Password</label>
                        <input
                            type="password"
                            required
